		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "고객 예약 페이지",
									"targetURL": "#syncc201booking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc201booking-display": {
								"semanticObject": "syncc201booking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c201.booking",
									"url": sap.ui.require.toUrl("sync/c201/booking")
								}
							}
						}
					}
