sap.ui.define([
    ...
    function (Controller, JSONModel, History, UIComponent, Filter, FilterOperator, MessageToast, Fragment, syncStyleClass, Text, Button, Dialog, toss) {
        ...
        return Controller.extend("sync.c201.booking.controller.View4", {
            onInit: function () {
                var oData = {
                    sImageBig  : null,
                    sFirstName : null,
            ...
            _onRouteMatched: function(oEvent){
                ...
                var sImageBig = "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/" + sRoomType + "B.jpg";
            ...
            onTile: function(oEvent){
                ...
                oEvent.oSource.setBackgroundImage('https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/BACK.jpg');
