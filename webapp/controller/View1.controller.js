sap.ui.define([
    ...
    function (Controller, JSONModel, UIComponent, DateRange, MessageToast, DateFormat, coreLibrary, DateTypeRange, library, History) {
        ...
        return Controller.extend("sync.c201.booking.controller.View1", {
            onInit: function () {
                 ...
                 */
                var oData = {
                    Seoul: "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/Seoul.jpg",
                    Jeju: "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/Jeju.jpg",
                    sPlant: null,
            ...
            onPressItem: function (oEvent) {
                ...
                var sPlant = sPath.sId.slice(-5).replaceAll('-','')
                var oViewModel = this.getView().getModel("view");
                if (sPlant == "Seoul"){
