sap.ui.define([
    ...
    function (Controller, JSONModel, History, UIComponent, Filter, FilterOperator, MessageToast, Fragment, syncStyleClass, Text, Button, Dialog, toss) {
        ...
        return Controller.extend("sync.c201.booking.controller.View5", {
            onInit: function () {
                var oData = {
                    sPlant     : null,
                    sClassType : null,
            ...
            _onRouteMatched: function(oEvent){
                ...
                var iIndex      = this.getView()._$oldContent.context.baseURI.search('orderId');
                var sOrderId    = this.getView()._$oldContent.context.baseURI.substring(iIndex+8,iIndex+16)
                var sPath       = "/BookFinishSet('" + sOrderId + "')"
                    ...
                    success: function(data){
                        ...
                        switch (data.Roomid.substring(3,5)) {
                            case "SG":
                                ...
                                sBedType = "Single";
                                sRoomSize  = "24㎡";
                                sImages = "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/STSGB.jpg";
                                break;
                            ...
                            case "DB":
                                ...
                                switch (sClassType) {
                                    case "Standard":
                                        sRoomSize  = "28㎡";
                                        sImages = "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/STDBTWB.jpg";
                                        break;

                                    case "Deluxe":
                                        sRoomSize  = "36㎡";
                                        sImages = "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/DLDBTWB.jpg";
                                        break;

                                    case "Grand Deluxe":
                                        sRoomSize  = "43㎡";
                                        sImages = "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/GDDBTWB.jpg";
                                        break;

                                    case "Executive":
                                        sRoomSize  = "51㎡";
                                        sImages = "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/ECDBTWB.jpg";
                                        break;
                                }
                                break;
                            ...
                            case "SU":
                                ...
                                switch (sClassType) {
                                    case "Deluxe":
                                        ...
                                        sRoomSize  = "66㎡"
                                        sImages = "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/DLSUB.jpg";
                                        break;

                                    case "Grand Deluxe":
                                        sClassType = "Grand Deluxe Suite"
                                        sRoomSize  = "71㎡"
                                        sImages = "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/GDSUB.jpg";
                                        break;

                                    case "Executive":
                                        sClassType = "Executive Suite"
                                        sRoomSize  = "84㎡"
                                        sImages = "https://edu.bgis.co.kr:8443/sap/bc/ui5_ui5/sap/zc201sd01/images/ECSUB.jpg";
                                        break;
                                }
                                break;
                        }                            
